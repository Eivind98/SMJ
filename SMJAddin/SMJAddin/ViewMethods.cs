    ...
    public static class ViewMethods
    {
        public static void CreateSheetAndFilters(Element element)
        {
            if (element is Pipe)
            {
                ...
                string filterName = prefixText + text;
                ...
                ParameterFilterElement filter = ParameterFilterElement.Create(doc, filterName, builtInCategories, to);
